...
class GameState:
    def __init__(self):
        ...
        self.flipBoard = False  # <-- Added this line

    def makeMove(self, move):
        self.board[move.startRow][move.startCol] = "--"
        promotedPiece = move.pieceMoved
        if move.isPawnPromotion:
            promotedPiece = move.pieceMoved[0] + move.promotionChoice
        self.board[move.endRow][move.endCol] = promotedPiece
        self.moveLog.append(move)
        self.whiteToMove = not self.whiteToMove
        self.flipBoard = not self.flipBoard  # <-- Flip the board after every move
    ...
    def undoMove(self):
        if len(self.moveLog) != 0:
            ...
            self.whiteToMove = not self.whiteToMove
            self.flipBoard = not self.flipBoard  # <-- Flip board back on undo
...
class Move:
    ...
    def __init__(self, startSq, endSq, board, isEnPassantMove=False, isCastleMove=False, promotionChoice=None):
        ...
        self.promotionChoice = promotionChoice if promotionChoice else 'Q'  # default promotion to queen
